...
<head>
    ...
    <title>Surat Masuk - Agenda Surat Digital</title>
...
<body class="position-relative">
    ...
    <main class="container py-5 position-relative z-1">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h1 class="fw-extrabold h2 mb-1 text-white">Daftar Surat Masuk</h1>
                <p class="text-subtle-light mb-0">Menampilkan seluruh surat dengan jenis "Masuk"</p>
            </div>
            @if(auth()->user()->role === 'admin')
            <div>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <span>Belum ada data surat masuk.</span>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
