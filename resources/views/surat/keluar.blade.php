...
<head>
    ...
    <title>Surat Keluar - Agenda Surat Digital</title>
...
<body class="position-relative">
    ...
    <main class="container py-5 position-relative z-1">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h1 class="fw-extrabold h2 mb-1 text-white">Daftar Surat Keluar</h1>
                <p class="text-subtle-light mb-0">Menampilkan seluruh surat dengan jenis "Keluar"</p>
            </div>
            @if(auth()->user()->role === 'admin')
            <div>
                    ...
                    <tbody>
                        @forelse($surats as $index => $item)
                            <tr>
                                ...
                                <td class="text-subtle-light fw-medium">{{ $item->pengirim_penerima }}</td>
                                <td class="text-subtle-light">{{ $item->perihal }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    ...
                                    <span>Belum ada data surat keluar.</span>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                ...
                <div class="modal-content modal-cyber text-start p-2">
                    <div class="modal-body text-center p-4">
                        ...
                        <p class="text-subtle-light small mb-4">
                            Apakah Anda yakin ingin menghapus data surat <strong class="text-white">{{ $item->nomor_surat }}</strong>?
                        </p>
                        <div class="d-flex justify-content-center gap-2">
                            <button type="button" class="btn btn-outline-light rounded-pill px-4 py-2 small" data-bs-dismiss="modal">Batal</button>
    ...
    <footer class="mt-auto py-4 text-center border-top border-purple position-relative z-1" style="border-color: rgba(168, 85, 247, 0.2) !important;">
        <div class="container">
            <p class="small text-subtle-light mb-0">&copy; {{ date('Y') }} <strong>AgendaSurat.Digital</strong></p>
        </div>
    </footer>
