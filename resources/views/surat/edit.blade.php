...
<head>
    ...
    <title>Edit Surat - Agenda Surat Digital</title>
...
<body class="position-relative">
    ...
    <div class="container my-5 position-relative z-1" style="max-width: 700px;">
        <div class="mb-4">
            ...
            <h3 class="fw-bold mt-2 mb-1">Edit Data Surat</h3>
            <p class="small mb-0">Perbarui rincian informasi agenda surat di bawah ini</p>
        </div>
    ...
    <select name="jenis_surat" id="jenis_surat" class="form-select" required>
        ...
        <option value="keluar" {{ old('jenis_surat', $surat->jenis_surat) == 'keluar' ? 'selected' : '' }}>Surat Keluar</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pengirim_penerima" name="pengirim_penerima" value="{{ $surat->pengirim_penerima }}" required>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-neon-purple px-4">
                        <i class="bi bi-pencil-square me-1"></i> Perbarui Surat
                    </button>
                </div>
            </form>
        </div>
    ...
    <footer class="mt-auto py-4 text-center border-top border-purple position-relative z-1" style="border-color: rgba(168, 85, 247, 0.2) !important;">
        <div class="container">
            <p class="small mb-0">&copy; {{ date('Y') }} <strong>AgendaSurat.Digital</strong> — Form Edit Surat.</p>
        </div>
    </footer>
